...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.deconv5 = nn.ConvTranspose2d(32, 3, kernel_size=2, stride=2)
    ...
    def forward(self, x, skips):
        ...
        original4 = skips['conv4_1']
        x_deconv = self.recon_block1(x, LH4, HL4, HH4, original4)

        x2 = self.deconv2(x_deconv + x1)
        x2 = self.activation2(x2)
        LH3, HL3, HH3 = skips['pool3']
        original3 = skips['conv3_1']
        # c, h, w = LH2.size()[-3:]
        ...
        x_deconv2 = self.recon_block2(x1, LH3, HL3, HH3, original3)

        x3 = self.deconv3(x_deconv2 + x2)
        x3 = self.activation3(x3)
        LH2, HL2, HH2 = skips['pool2']
        # c, h, w = skips['conv2_1'].size()[-3:]
        original2 = skips['conv2_1']
        # c, h, w = LH3.size()[-3:]
        ...
        x_deconv3 = self.recon_block3(x3, LH2, HL2, HH2, original2)

        x4 = self.deconv4(x_deconv3 + x3)
        x4 = self.activation4(x4)
        LH1, HL1, HH1 = skips['pool1']
        original1 = skips['conv1_1']
        # c, h, w = LH4.size()[-3:]
        ...
        x_deconv4 = self.recon_block4(x1, LH1, HL1, HH1, original1)

        x5 = self.deconv5(x_deconv4 + x4)
